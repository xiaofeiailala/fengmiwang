...
<%
    ...
    if(id != null){
        ...
        Goods goods = gs.goodsById(id1);
        request.setAttribute("goods",goods );
        request.setAttribute("GoodsPath","update");
    }else {
        request.setAttribute("GoodsPath","add");
    }
...
<div class="container" style="margin-top: 20px;">
    ...
    <form class="form-horizontal"
          ...
          action="${pageContext.request.contextPath}/Goods/${GoodsPath}"
          method="post">
                ...
                <div class="input-group">
                    ...
                    <input type="hidden" class="form-control" id="typeId"
                           name="typeId" value="${goods.typeId}"> <input type="text"
                                                                         ...
                                                                         value="${goods.typeName}" placeholder="默认为测试类" aria-label="...">
                </div>
                <!-- /input-group -->
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="file" name="imgPath" value="${goods.imgPath}"  onchange="showPreview(this)" >${goods.imgPath}<br />
                <c:if test="${not empty goods.imgPath}">
<%--                    <img src="http://localhost:8081/uploadfile/images/${goods.imgPath}"--%>
                    <img src="${pageContext.request.contextPath}/images/imgGoods/${goods.imgPath}"
