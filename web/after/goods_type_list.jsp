    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse"
            ...
            <ul class="nav navbar-nav">
                <li><a href="<%=path%>/Goods/query">商品管理 <span class="sr-only">(current)</span></a></li>
                <li class="active"><a href="<%=path%>/GoodsType/query">商品类型管理</a></li>
                <li ><a href="<%=path%>/User/query?pageNo=1">用户管理</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a style="padding-left:0px" href="<%=path%>/Admin/quit">退出</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<div class="container" style="margin-top:20px;">
    <form id="deleteFrom" action="${pageContext.request.contextPath}/goods/deleteBatch" method="post">
        <table style="text-align: center;margin-right:10px;width:99%"
            ...
            <tbody>
            <c:forEach items="${goodsTypes}" var="goodsType" varStatus="obj">
                ...
                <tr>
                    ...
                    <td><a href="<%=path%>/after/add_goods_type.jsp?id=${goodsType.id}&pageNo=${pageNo}" onclick="if(confirm('是否确定编辑'+'${user.username}'+'？')==false)return false">
                        <span class="glyphicon glyphicon-edit"  color="#5BC0DE"></span></a></td>

                    <td><a class="glyphicon glyphicon-trash" color="#5BC0DE"
                           style="text-decoration:none"
                           href="<%=path%>/GoodsType/delete?id=${goodsType.id}&pageNo=${pageNo}" onclick="if(confirm('是否确定删除'+'${goodsType.typeName}'+'？')==false)return false" ></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
...
<div class="container">
    <nav aria-label="..." class="navbar-right" style="margin-right: 15px">
        <ul class="pagination">
            <li><a class=" btn-info"
                   href="<%=path%>/GoodsType/query?pageNo=1" aria-label="Previous">
            ...
            %>
            <li><a class=" btn-info"
                   href="<%=path %>/GoodsType/query?pageNo=${pageNo-1}"
            ...
            <li><a class="btn"
                   href="<%=path %>/GoodsType/query?pageNo=${pageNo+1}">${pageNo}</a></li>
            <li><a class="btn-info"
                   href="<%=path %>/GoodsType/query?pageNo=${pageNo+1}"
            ...
            <li><a class=" btn-info"
                   href="<%=path %>/GoodsType/query?pageNo=${pageNo}">${pageNo}</a></li>
            <li class="disabled"><a href="#" aria-label="Previous">»<span
                    class="sr-only">(current) </span></a></li>
            <%
                }
            %>
            <li><a class=" btn-info"
                   href="<%=path %>/GoodsType/query?pageNo=${pageCount}"
