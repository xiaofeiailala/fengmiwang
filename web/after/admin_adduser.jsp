...
<form id="form"  method="post" action="${pageContext.request.contextPath}/User/addUser" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-18" data-genuitec-path="/FengMi/WebRoot/before/register.html">
