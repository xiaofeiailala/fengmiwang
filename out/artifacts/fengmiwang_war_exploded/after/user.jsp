    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse"
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="<%=path%>/User/query">用户管理</a></li>
...
<div class="container">
    <form class="form-inline"
          action="${pageContext.request.contextPath}/User/query?pageNo=1"
          method="post">
        <div class="col-md-4">
...
<div class="container">
    <nav aria-label="..." class="navbar-right" style="margin-right: 15px">
        <ul class="pagination">
            <li><a class=" btn-info"
                   href="<%=path%>/User/query?pageNo=1&sex=${sex}&username=${username}" aria-label="Previous">
            ...
            %>
            <li><a class=" btn-info"
                   href="<%=path %>/User/query?pageNo=${pageNo-1}&sex=${sex}&username=${username}"
            ...
            <li><a class="btn"
                   href="<%=path %>/User/query?pageNo=${pageNo+1}&sex=${sex}&username=${username}">${pageNo}</a></li>
            <li><a class="btn-info"
                   href="<%=path %>/User/query?pageNo=${pageNo+1}&username=${username}&sex=${sex}"
            ...
            <li><a class=" btn-info"
                   href="<%=path %>/User/query?pageNo=${pageNo}&sex=${sex}&username=${username}">${pageNo}</a></li>
            <li class="disabled"><a href="#" aria-label="Previous">»<span
                    class="sr-only">(current) </span></a></li>
            <%
                }
            %>
            <li><a class=" btn-info"
                   href="<%=path %>/User/query?pageNo=${pageCount}&sex=${sex}&username=${username}"
