    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse"
            ...
            <ul class="nav navbar-nav">
                <li class="active"><a href="<%=path%>/Goods/query">商品管理 <span
                        class="sr-only">(current)</span></a></li>
                <li><a href="<%=path%>/GoodsType/query">商品类型管理</a></li>
                <li><a href="<%=path%>/User/query">用户管理</a></li>
                <li><a href="<%=path%>/Order/query">订单管理</a></li>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6" style="text-align: right; padding-right: 25px;">
            <form class="form-inline" action="<%=path%>/Goods/query">
...
<div class="container" style="margin-top: 20px;">
    <form id="deleteForm"
        ...
        <table style="text-align: center; margin-right: 10px; width: 99%"
            ...
            <c:forEach items="${goodsList}" var="goods" varStatus="obj">
                <tr>
                    ...
                    <td>
                        <img
                                src="${pageContext.request.contextPath}/images/imgGoods/${goods.imgPath}"
...
<div class="container">
    <nav aria-label="..." class="navbar-right" style="margin-right: 15px">
        <ul class="pagination">
            <li><a class=" btn-info"
                   href="<%=path %>/Goods/query?pageNo=1" aria-label="Previous">
            ...
            %>
            <li><a class=" btn-info"
                   href="<%=path %>/Goods/query?pageNo=${pageNo-1}"
            ...
            <li><a class="btn"
                   href="<%=path %>/Goods/query?pageNo=${pageNo+1}">${pageNo}</a></li>
            <li><a class="btn-info"
                   href="<%=path %>/Goods/query?pageNo=${pageNo+1}"
            ...
            <li><a class=" btn-info"
                   href="<%=path %>/Goods/query?pageNo=${pageNo}">${pageNo}</a></li>
            <li class="disabled"><a href="#" aria-label="Previous">»<span
                    class="sr-only">(current) </span></a></li>
            <%
                }
            %>
            <li><a class=" btn-info"
                   href="<%=path %>/Goods/query?pageNo=${pageCount}"
